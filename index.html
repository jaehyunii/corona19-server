          ...
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Default"><a href="#api-Default">API Methods - Default</a></li>
                    <li data-group="Default" data-name="locationDistrictNameGet" class="">
                      <a href="#api-Default-locationDistrictNameGet">locationDistrictNameGet</a>
                    </li>
                    <li data-group="Default" data-name="locationGet" class="">
                      <a href="#api-Default-locationGet">locationGet</a>
                    </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>Corona Circle API</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Default">
                  <h1>Default</h1>
                    <div id="api-Default-locationDistrictNameGet">
                      <article id="api-Default-locationDistrictNameGet-0" data-group="User" data-name="locationDistrictNameGet" data-version="0">
                        <div class="pull-left">
                          <h1>locationDistrictNameGet</h1>
                          <p>Returns all location where the infected person visited at district</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/location/{districtName}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-locationDistrictNameGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-locationDistrictNameGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-locationDistrictNameGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-locationDistrictNameGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-locationDistrictNameGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-locationDistrictNameGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-locationDistrictNameGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-locationDistrictNameGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-locationDistrictNameGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-locationDistrictNameGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-locationDistrictNameGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-locationDistrictNameGet-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://https://220.118.63.34:3000/location/{districtName}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-locationDistrictNameGet-0-java">
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Default-locationDistrictNameGet-0-android">
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-locationDistrictNameGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Default-locationDistrictNameGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *districtName = districtName_example; // 
...
[apiInstance locationDistrictNameGetWith:districtName
              completionHandler: ^(array[Location] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Default-locationDistrictNameGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var CoronaCircleApi = require('corona_circle_api');
...
api.locationDistrictNameGet(districtName, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Default-locationDistrictNameGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-locationDistrictNameGet-0-csharp">
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling DefaultApi.locationDistrictNameGet: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Default-locationDistrictNameGet-0-php">
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Default-locationDistrictNameGet-0-perl">
...
if ($@) {
    warn "Exception when calling DefaultApi->locationDistrictNameGet: $@\n";
                            ...
                            <div class="tab-pane" id="examples-Default-locationDistrictNameGet-0-python">
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">districtName*</td>
<td>


    <div id="d2e199_locationDistrictNameGet_districtName">
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-locationDistrictNameGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-locationDistrictNameGet-200-schema">
                                  <div id='responses-locationDistrictNameGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    ...
    "items" : {
      "$ref" : "#/definitions/Location"
                                        ...
                                        $('#responses-locationDistrictNameGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-locationDistrictNameGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-locationDistrictNameGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Default-locationGet">
                      <article id="api-Default-locationGet-0" data-group="User" data-name="locationGet" data-version="0">
                        <div class="pull-left">
                          <h1>locationGet</h1>
                          <p>Returns all location where the infected person visited</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/location</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-locationGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-locationGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-locationGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-locationGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-locationGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-locationGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-locationGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-locationGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-locationGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-locationGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-locationGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-locationGet-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://https://220.118.63.34:3000/location"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-locationGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.DefaultApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Default-locationGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-locationGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Default-locationGet-0-objc">
...
[apiInstance locationGetWithCompletionHandler: 
              ^(array[Location] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Default-locationGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var CoronaCircleApi = require('corona_circle_api');
...
api.locationGet(callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Default-locationGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-locationGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling DefaultApi.locationGet: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Default-locationGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Default-locationGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::DefaultApi;
...
if ($@) {
    warn "Exception when calling DefaultApi->locationGet: $@\n";
                            ...
                            <div class="tab-pane" id="examples-Default-locationGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    ...
    print("Exception when calling DefaultApi->locationGet: %s\n" % e)</code></pre>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-locationGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-locationGet-200-schema">
                                  <div id='responses-locationGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    ...
    "items" : {
      "$ref" : "#/definitions/Location"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-locationGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-locationGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-locationGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
          ...
          <div id="footer">
            <div id="api-_footer">
              <p>Suggestions, contact, support and error reporting;
                  ...
                  <div class="app-desc">Contact Info: <a href="wang1@hanyang.ac.kr">wang1@hanyang.ac.kr</a></div>
              </p>
